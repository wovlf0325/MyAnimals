						...
						<form action="/MyAnimals/shopinsert.do" method="post" enctype="multipart/form-data">
							...
							<div class="row gtr-uniform">
								<div class="col-6 col-12-xsmall">
									<input type="text" name="shop_name" id="demo-name" value="" placeholder="Name" required="required"/>
								</div>
								<div class="col-12">
								...
								<div class="col-6 col-12-xsmall">
									<input type="text" name="shop_price" id="demo-email" value="" required="required" placeholder="가격"
										onkeypress="inNumber();" />
								</div>
								<div class="col-6 col-12-xsmall">
									<input type="text" name="shop_quantity" required="required" id="demo-email" value="" placeholder="수량"
										onkeypress="inNumber();" />
								</div>
								<div class="col-12">
									<textarea name="shop_content" id="demo-message" placeholder="제품 설명을 작성해 주세요"
										rows="6"></textarea>
								</div>
								<div>
