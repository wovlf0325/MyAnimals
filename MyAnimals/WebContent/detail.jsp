...
function addCalendar(){
	open("calendar.do?command=insertCalendar&Center_seq="+<%=dto.getCenter_seq()%>,"","width=300,height=250");
}
...
%>
	<td>
		...
		<a href="calendar.do?command=insertCalendar&year=<%=year%>&month=<%=month%>&date=<%=i%>&lastday=<%=lastDay%>">
