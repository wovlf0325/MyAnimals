var SITE = function(){
	...
	var openModalMenu = function(menu_code){
		$.cocoaDialog.close();
		$.ajax({
			type: 'POST',
			data: {
			...
			success: function(html){
				var $html = $(html);
				$.cocoaDialog.open({type: 'site_modal_menu', custom_popup: $html, hide_event: function(e){
						var target = $(e.target);
	...
	return {
		...
		'openModalMenu' : function(menu_code){
			openModalMenu(menu_code);
		},
